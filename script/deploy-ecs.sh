...
usage="Usage: deploy-ecs.sh [gitfanfiction-app-web|gitfanfiction-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/gitfanfiction:$2"
...
aws ecs update-service --cluster gitfanfiction \
  --no-cli-pager \
  --region "$ecs_region" \
